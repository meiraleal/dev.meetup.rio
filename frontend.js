	...
	renderStoryCircle(story, index) {
      ...
      >
        <uix-avatar
          ...
          style="background-image: url(${story.avatar}); background-size: cover;"
        ></uix-avatar>
        <span style="margin-top: 4px; font-size: 12px; color: #666;">
          ${story.username}
        </span>
      </div>
    `;
